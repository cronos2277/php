<aside class="sidebar">
    <nav class="menu mt-3">
        <ul class="nav-list">
            ...
            <li class="nav-item"><a href=""><i class="icofont-ui-calendar mr-2"></i>Relatório Mensal</a></li>           
            <li class="nav-item"><a href=""><i class="icofont-chart-histogram mr-2"></i>Relatório Gerencial</a></li>           
    ...
    <div class="sidebar-widgets">
        <div class="sidebar-widget">
            ...
            <div class="info">
                <span class="main" <?= $activeClock === 'workedInterval' ? 'active-clock' : '' ?>>
                    <?= $workedInterval; ?>
                </span>
        ...
        <div class="sidebar-widget">
            ...
            <div class="info">
                <span class="main" <?= $activeClock === 'exitTime' ? 'active-clock' : '' ?>>
                    <?= $exitTime ?>
                </span>
