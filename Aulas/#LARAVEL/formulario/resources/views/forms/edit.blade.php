...
@section('section')  
  <main class="container mt-5"> 
    ...
    <hr>
    <form class="row g-3 mt-3" action="/update/{{$user->id}}" method="POST">
      @csrf
      @method('PUT')
      <input type="hidden" value="{{$user->id}}" name="id_form" readonly />
        <div class="col-md-6">
          <div class="input-group">
            ...
            <input type="text" class="form-control @if($errors->has('nome_form')) is-invalid @endif" placeholder="Nome" aria-label="Nome" name="nome_form" value="{{$user->nome}}">
        ...
        <div class="col-md-2 col-6">
          <div class="input-group">
            ...
            <input type="text" class="form-control @if($errors->has('idade_form')) is-invalid @endif"" placeholder="Idade" aria-label="Idade" name="idade_form" value="{{$user->idade}}">
        ...
        <div class="col-md-3 col-6">
          <div class="input-group">
            ...
            <input type="text" class="form-control @if($errors->has('sal_form')) is-invalid @endif"" placeholder="salario" aria-label="salario" name="sal_form" value="{{$user->salario}}">
