...
return [
    ...
    */
    ...
    | os rastreamentos de pilha serão mostrados em cada erro que ocorrer dentro do seu
    | inscrição. Se desativado, uma página de erro genérica simples é mostrada.
    |
    */
    ...
    */
    ...
    | em frente e defina isso como um padrão sensato para você.
    |
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Este array de aliases de classe será registrado quando este aplicativo
    | começou. No entanto, sinta-se à vontade para registrar quantos desejar
    | os aliases são carregados "lentamente" para não prejudicar o desempenho.
    |
    */
